    ...
    <div className="bg-white">
      <div className="mt-14 mb-8 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-20 p-2">
        <div className="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
          <p className=" text-4xl font-extrabold">Le nom de l'article</p>
        ...
        <div className="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-h-4 bg-gray-100">
          <div className="sm:rounded-lg mt-4 bg-gray-200">
            <img
              src=""
              alt=""
          ...
          <div className="grid grid-cols-3 mt-4 gap-4">
            <div className="col-span-1 sm:rounded-lg bg-green-300">
              {" "}
              <img
                src=""
                alt=""
            ...
            <div className="col-span-1 sm:rounded-lg bg-yellow-300 ">
              {" "}
              <img
                src=""
                alt=""
            ...
            <div className="col-span-1 sm:rounded-lg bg-red-300">
              {" "}
              <img
                src=""
                alt=""
